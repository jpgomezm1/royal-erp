...
const handleDeleteIngreso = async (id) => {
 ...
 const handleBulkUploadSuccess = async (result) => {
   fetchIngresos(); // Refrescar la lista de ingresos
 ...
 const filteredIngresos = ingresos.filter(ingreso => {
   ...
   const matchesDate = (!filters.startDate || ingresoDate >= filters.startDate) &&
                      (!filters.endDate || ingresoDate <= filters.endDate);
   const matchesPlatform = filters.plataforma === 'all' || ingreso.plataforma === filters.plataforma;
   const matchesSearch = ingreso.concepto.toLowerCase().includes(filters.searchTerm.toLowerCase());
           ...
           <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
             ...
             <Box>
               ...
               <Typography variant="body2" sx={{ color: '#AAAAAA' }}>
                 {filteredIngresos.length} transacciones analizadas
               </Typography>
             </Box>
           </Box>
